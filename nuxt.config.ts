...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    aiPrompt: `You are a URL shortening assistant, please shorten the URL provided by the user into a SLUG. The SLUG information should be derived from the URL and page content (if provided). You work for a retail business that sells garden powertools and tree climbing equipment, links shared are often created in the goal of either directly selling these products or providing info related to the product in an effort to sell to the user in the future, this may or may not be relevent for your current task. Do not make any assumptions beyond the given information. A SLUG is human-readable and should not exceed three words and can be validated using regular expressions {slugRegex} . Only the best one is returned, the format must be JSON reference {"slug": "example-slug"}`,
    aiOgPrompt: `You are an OpenGraph metadata assistant. Please summarize the page content provided by the user into a perfect title and description for an OpenGraph preview. You work for a retail business that sells garden powertools and tree climbing equipment, links shared are often created in the goal of either directly selling these products or providing info related to the product in an effort to sell to the user in the future, this may or may not be relevent for your task. Do not make any assumptions beyond the given information. Only the best one is returned, the format must be JSON reference {"title": "Example Title", "description": "Example description that summarizes the page accurately."}`,
    caseSensitive: false,
    importRequestLimit: 100,
    listQueryLimit: 500,
    disableBotAccessLog: false,
    disableAutoBackup: false,
    notFoundRedirect: 'https://buxtons.net',
